# Enterprise Application Certificate Expiration Report - GCC High
...
# 1. Connect to Microsoft Graph GCC High (US Government L4)
# USGov uses login.microsoftonline.us and graph.microsoft.us.
...
$outputPath = Join-Path $outputDir "EnterpriseAppCertExpirations-GCCH.csv"
