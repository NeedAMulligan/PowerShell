...
$LogPath = Join-Path $LogRoot "Intune-Company-Portal-Global-$Timestamp.log"
...
try {
    Write-Log -Message "Starting Company Portal deployment script version $ScriptVersion."
